...
function ModalNewsletter({ valor, ativo, imagem, imagemFundo }: PropsNewsletter) {
  ...
  // Mostrar o modal após o primeiro scroll, se ainda não foi exibido
  useEffect(() => {
    const handleScroll = () => {
      if (!localStorage.getItem('newsletter') && ativo) {
        setIsModalVisible(true);
        localStorage.setItem('newsletter-scroll-triggered', 'true');
        window.removeEventListener('scroll', handleScroll);
      }
    };

    if (!localStorage.getItem('newsletter-scroll-triggered') && ativo) {
